...
/**
* @title Shadowlink Token
**/
contract ShadowlinkToken is ERC20, Pauseable {
    ...
    string public constant name = "Shadowlink";
    string public constant symbol = "Shadowlink";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY =   500000000 * (10 ** uint256(decimals));
    
    function ShadowlinkToken() public {
        owner = msg.sender;
